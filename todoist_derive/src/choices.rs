...
pub fn derive(tokens: TokenStream) -> TokenStream {
    ...
    quote! {
        ...
        impl crate::interactions::commands::arguments::ArgumentConverter for #enum_name {
            ...
            fn convert(data: &::twilight_model::application::interaction::application_command::CommandOptionValue) -> Result<Self, Self::Error> {
                if let ::twilight_model::application::interaction::application_command::CommandOptionValue::String(value) = data {
                    match value.as_str() {
                        ...
                        _ => Err(crate::interactions::commands::arguments::Error::InvalidType)
                    }
                } else {
